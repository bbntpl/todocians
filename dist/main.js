...
const Todo = (() => {
    ...
    const setTask = (id, props) => {
        ...
        const newTask = new _task__WEBPACK_IMPORTED_MODULE_3__.Task(title, desc, checklist, dueDate);
